...
import { SelectedFields, Column as Column$1, Table as Table$1, Subquery, TableConfig, entityKind, QueryPromise, Assume, SQLWrapper, BuildColumns, ColumnBuilderBase } from 'drizzle-orm';
export { and, asc, avg, avgDistinct, between, count, countDistinct, desc, eq, exists, gt, gte, inArray, isNotNull, isNull, like, lt, lte, max, min, ne, not, notBetween, notExists, notIlike, notInArray, or, sql, sum, sumDistinct } from 'drizzle-orm';
import { TypedQueryBuilder } from 'drizzle-orm/query-builders/query-builder';
import { GetSelectTableName, GetSelectTableSelection, SelectMode, JoinNullability, SelectResult, BuildSubquerySelection, JoinType, AddAliasToSelection, AppendToResult, AppendToNullabilityMap } from 'drizzle-orm/query-builders/select.types';
import { View, SQL, ColumnsSelection, Placeholder, Query } from 'drizzle-orm/sql';
...
type ExtractNonVirtualColumnNames<table extends Table | unknown, columnNames = keyof table & string> = columnNames extends columnNames ? table[columnNames & keyof table] extends ReferenceColumn | ScalarColumn | EnumColumn | JSONColumn ? columnNames : never : never;
...
type GetTable<table, tableName extends string = string, schema = {}, tableNames extends string = {} extends schema ? string : ExtractTableNames<schema>, enumNames extends string = {} extends schema ? string : ExtractEnumNames<schema>> = {} extends table ? {} : table extends {
    ...
    [columnName in keyof table]: table[columnName] extends ScalarColumn ? ScalarColumn : table[columnName] extends ReferenceColumn ? ReferenceColumn<table[columnName][" scalar"], table[columnName][" optional"], `${tableNames}.id`> : table[columnName] extends JSONColumn ? JSONColumn : table[columnName] extends OneColumn ? OneColumn<Exclude<keyof table & string, columnName | "id">> : table[columnName] extends ManyColumn ? {} extends schema ? ManyColumn : table[columnName] extends ManyColumn<tableNames> ? ManyColumn<table[columnName][" referenceTable"], ExtractReferenceColumnNames<schema[table[columnName][" referenceTable"] & keyof schema], tableName> & string> : ManyColumn<Exclude<tableNames, tableName>> : table[columnName] extends EnumColumn ? EnumColumn<enumNames> : Column;
} : {
    id: IdColumn;
} & {
    [columnName: string]: Column;
...
type UserValue = string | string[] | number | number[] | boolean | boolean[] | Hex | Hex[] | bigint | bigint[] | object | null | undefined;
type UserTable = {
 ...
 */
type SelectBuilder<TSelection extends SelectedFields<Column$1, Table$1> | undefined, TResultType extends "sync" | "async", TRunResult, TBuilderMode extends "db" | "qb" = "db"> = {
    from: <TFrom extends Table$1 | Subquery | View | SQL>(source: TFrom) => CreateSelectFromBuilderMode<TBuilderMode, GetSelectTableName<TFrom>, TResultType, TRunResult, TSelection extends undefined ? GetSelectTableSelection<TFrom> : TSelection, TSelection extends undefined ? "single" : "partial">;
};
/**
...
declare abstract class SelectQueryBuilderBase<THKT extends SelectHKTBase, TTableName extends string | undefined, TResultType extends "sync" | "async", TRunResult, TSelection extends ColumnsSelection, TSelectMode extends SelectMode, TNullabilityMap extends Record<string, JoinNullability> = TTableName extends string ? Record<TTableName, "not-null"> : {}, TDynamic extends boolean = false, TExcludedMethods extends string = never, TResult extends any[] = SelectResult<TSelection, TSelectMode, TNullabilityMap>[], TSelectedFields extends ColumnsSelection = BuildSubquerySelection<TSelection, TNullabilityMap>> extends TypedQueryBuilder<TSelectedFields, TResult> {
    ...
    leftJoin: JoinFn<this, TDynamic, "left">;
    rightJoin: JoinFn<this, TDynamic, "right">;
    innerJoin: JoinFn<this, TDynamic, "inner">;
    fullJoin: JoinFn<this, TDynamic, "full">;
    private setOperator;
    union: typeof this.setOperator;
    unionAll: typeof this.setOperator;
    intersect: typeof this.setOperator;
    intersectAll: typeof this.setOperator;
    except: typeof this.setOperator;
    exceptAll: typeof this.setOperator;
    where: (where: ((aliases: TSelection) => SQL | undefined) | SQL | undefined) => SelectWithout<this, TDynamic, "where">;
    having: (having: ((aliases: this["_"]["selection"]) => SQL | undefined) | SQL | undefined) => SelectWithout<this, TDynamic, "having">;
    groupBy: (...columns: (Column$1 | SQL)[]) => SelectWithout<this, TDynamic, "groupBy">;
    orderBy: (...columns: (Column$1 | SQL)[]) => SelectWithout<this, TDynamic, "orderBy">;
    limit: (limit: number | Placeholder) => SelectWithout<this, TDynamic, "limit">;
    offset: (offset: number | Placeholder) => SelectWithout<this, TDynamic, "offset">;
    toSQL: () => Query;
    as: <TAlias extends string>(alias: TAlias) => SubqueryWithSelection<this["_"]["selectedFields"], TAlias>;
    $dynamic: () => SelectDynamic<this>;
}
/**
 ...
 */
type SelectBase<TTableName extends string | undefined, TResultType extends "sync" | "async", TRunResult, TSelection extends ColumnsSelection, TSelectMode extends SelectMode = "single", TNullabilityMap extends Record<string, JoinNullability> = TTableName extends string ? Record<TTableName, "not-null"> : {}, TDynamic extends boolean = false, TExcludedMethods extends string = never, TResult = SelectResult<TSelection, TSelectMode, TNullabilityMap>[], TSelectedFields extends ColumnsSelection = BuildSubquerySelection<TSelection, TNullabilityMap>> = SelectQueryBuilderBase<SelectHKT, TTableName, TResultType, TRunResult, TSelection, TSelectMode, TNullabilityMap, TDynamic, TExcludedMethods, TResult, TSelectedFields> & QueryPromise<TResult>;
/**
 ...
 */
type Join<T extends AnySelectQueryBuilder, TDynamic extends boolean, TJoinType extends JoinType, TJoinedTable extends Table$1 | Subquery | View | SQL, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>> = T extends any ? SelectWithout<SelectKind<T["_"]["hkt"], T["_"]["tableName"], T["_"]["resultType"], T["_"]["runResult"], AppendToResult<T["_"]["tableName"], T["_"]["selection"], TJoinedName, TJoinedTable extends Table$1 ? TJoinedTable["_"]["columns"] : TJoinedTable extends Subquery | View ? Assume<TJoinedTable["_"]["selectedFields"], SelectedFields<Column$1, Table$1>> : never, T["_"]["selectMode"]>, T["_"]["selectMode"] extends "partial" ? T["_"]["selectMode"] : "multiple", AppendToNullabilityMap<T["_"]["nullabilityMap"], TJoinedName, TJoinType>, T["_"]["dynamic"], T["_"]["excludedMethods"]>, TDynamic, T["_"]["excludedMethods"]> : never;
/**
 ...
 */
type JoinFn<T extends AnySelectQueryBuilder, TDynamic extends boolean, TJoinType extends JoinType> = <TJoinedTable extends Table$1 | Subquery | View | SQL, TJoinedName extends GetSelectTableName<TJoinedTable> = GetSelectTableName<TJoinedTable>>(table: TJoinedTable, on: ((aliases: T["_"]["selection"]) => SQL | undefined) | SQL | undefined) => Join<T, TDynamic, TJoinType, TJoinedTable, TJoinedName>;
/**
 ...
 */
interface SelectHKT extends SelectHKTBase {
    _type: SelectBase<this["tableName"], this["resultType"], this["runResult"], Assume<this["selection"], ColumnsSelection>, this["selectMode"], Assume<this["nullabilityMap"], Record<string, JoinNullability>>, this["dynamic"], this["excludedMethods"], Assume<this["result"], any[]>, Assume<this["selectedFields"], ColumnsSelection>>;
}
/**
 ...
 */
type CreateSelectFromBuilderMode<TBuilderMode extends "db" | "qb", TTableName extends string | undefined, TResultType extends "sync" | "async", TRunResult, TSelection extends ColumnsSelection, TSelectMode extends SelectMode> = TBuilderMode extends "db" ? SelectBase<TTableName, TResultType, TRunResult, TSelection, TSelectMode> : SelectQueryBuilderBase<SelectQueryBuilderHKT, TTableName, TResultType, TRunResult, TSelection, TSelectMode>;
/**
 ...
 */
type TableWithColumns<T extends TableConfig> = Table$1<T> & {
    [key in keyof T["columns"]]: T["columns"][key];
};

type DrizzleDb = {
    select(): SelectBuilder<undefined, "async", void>;
    select<TSelection extends SelectedFields<Column$1, Table$1>>(fields: TSelection): SelectBuilder<TSelection, "async", void>;
    select(fields?: SelectedFields<Column$1, Table$1>): SelectBuilder<SelectedFields<Column$1, Table$1> | undefined, "async", void>;
    /**
     ...
     */
    execute: <record extends Record<string, unknown>>(query: SQLWrapper) => Promise<record[]>;
};
 ...
 */
type DrizzleTable<tableName extends string, table extends Table, schema extends Schema> = TableWithColumns<{
    name: tableName;
    schema: undefined;
    columns: BuildColumns<tableName, {
        [columnName in ExtractNonVirtualColumnNames<table>]: ColumnBuilderBase<{
            ...
            notNull: (table[columnName] & (ScalarColumn | ReferenceColumn | EnumColumn | JSONColumn))[" optional"] extends true ? false : true;
...
type ApiContext<schema extends Schema> = {
    db: DrizzleDb;
    tables: {
        [tableName in ExtractTableNames<schema>]: DrizzleTable<tableName, schema[tableName]["table"], schema>;
    };
};
type ApiRegistry<schema extends Schema> = {
    ...
    hono: Hono<{
        Variables: ApiContext<schema>;
    }>;
};

type Context<schema extends Schema = Schema, path extends string = string, input extends Input = {}> = ApiContext<schema> & {
    /**
     * Hono request object.
     *
...
type MiddlewareContext<schema extends Schema = Schema, path extends string = string, input extends Input = {}> = ApiContext<schema> & Context$1<Env, path, input>;
...
declare namespace Virtual {
    ...
    export type Drizzle<schema extends Schema> = ApiContext<schema>;
...
export { type Block, type BlockConfig, type ContractConfig, type DatabaseConfig, type Log, type NetworkConfig, type Transaction, type TransactionReceipt, Virtual, createConfig, createSchema, graphql };
